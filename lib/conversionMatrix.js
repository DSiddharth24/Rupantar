 ...
 * in services/messaging.js — the buildFormatPrompt() function already
 * checks options.length and will throw if > 3 and listMessage fallback
 * hasn't been implemented yet, so you won't silently break the UX.
 */
